                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group required">
                                        ...
                                        <input name="username" type="text" class="form-control" placeholder="{{ __('messages.username') }}" value="{{ $authUser->username }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="phone" type="text" class="form-control" placeholder="{{ __('messages.phone') }}" pattern="[0-9]+" value="{{ $authUser->phone }}">
                                    </div>
                                </div>
                            </div>
