                ...
                <div class="row no-gutters">
                    <div class="col card-form__body card-body bg-white">
                        <div class="form-row align-items-center mb-4">
                            <div class="col">
                                <p class="h4 mb-0">
                                    <strong class="headings-color">Edit Sites</strong>
                                </p>
                            </div>
                        </div>

                        <form action="{{ route('settings.site.edit', $sites->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-right mt-4">
                                <button type="submit" class="btn btn-primary">{{ __('Update Site') }}</button>
                                {{-- <a href="{{ route('settings.site.delete', $sites->id) }}" class="btn btn-light text-danger delete-confirm">
