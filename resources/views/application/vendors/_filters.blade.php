            ...
            <div class="row">
                <div class="col-sm-auto">
                    <div class="form-group">
                        <label for="filter[display_name]">Company Name</label>
                ...
                <div class="col-sm-auto">
                    <div class="form-group">
                        <label for="filter[contact_name]">Project Manager Name</label>
                ...
                <div class="col-sm-auto">
                    <div class="form-group">
                        <label for="filter[contact_name]">Phone Number</label>
                        <input name="filter[contact_name]" type="text" class="form-control" value="{{ Request::get("filter")==['contact_name'] }}" placeholder="{{ __('messages.search') }}">
                    </div>
                </div>
                <div class="col-sm-auto">
                    <div class="form-group">
                        <label for="filter[contact_name]">Delivery Location</label>
                        <input name="filter[contact_name]" type="text" class="form-control" value="{{ Request::get("filter")==['contact_name'] }}" placeholder="{{ __('messages.search') }}">
                    </div>
                </div>
                <div class="col-sm-auto">
                    <div class="form-group">
                        <label for="filter[contact_name]">Price Per Tonne (RM)</label>
                        <input name="filter[contact_name]" type="text" class="form-control" value="{{ Request::get("filter")==['contact_name'] }}" placeholder="{{ __('messages.search') }}">
                    </div>
                </div>
            </div>
