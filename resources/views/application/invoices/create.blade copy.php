        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('expenses') }}">Client Site</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-5 p-0 card-body" style="margin: auto;">
                            <ul class="timeline">
                                ...
                                <li>
                                    <a href="#">Arrival</a>
                                    <a href="#" class="float-right">12/09/2020 2:00pm</a>
                                    <p>Received with accurate amout</p>
                                </li>
                                <li>
                                    <a href="#">Receipt</a>
                        ...
                        <div class="float-left">
                            <div class="btn-group">
                                <a href="{{ route('expenses') }}" type="button" class="btn btn-primary" aria-expanded="false">
