        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Create Invoice Contract</li>
                </ol>
            </nav>
            <h1 class="m-0">Create Invoice Contract</h1>
        </div>
    </div>
@endsection
            ...
            <div class="container">
                <div class="row">
                    <div class="boxes" style="margin: auto; width: 75%">
                        ...
                        <!-- <div class="form-group">
                             <label><strong>Previous Trip's Quantity:</strong></label>
...
@section('page_body_scripts')
    @include('application.invoices._js2')
    <script>
