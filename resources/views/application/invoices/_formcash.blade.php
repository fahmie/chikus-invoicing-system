    ...
    <div class="row no-gutters card-form__body card-body bg-white">
        ...
        <div class="col-xl-4 pr-2">
            <div class="form-group required">
                <label for="unit">Driver Name & IC</label>
                <select name="driver_id" id="driver_id" data-toggle="select" >
            ...
            <div class="form-group required">
                <label for="unit">Plate Number</label>
                <select name="plate_number_id" id="plate_number_id" data-toggle="select" >
                    <option disabled selected>Select Plate No.</option>
                    @foreach ($plate_num as $plate_num)
                    <option value="{{ $plate_num->plate_number}}" @if(isset($invoice) && $invoice->plate_number == $plate_num->plate_number) selected @endif>{{$plate_num->plate_number}}</option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="col-xl-4 pr-4 pl-4">
            <div class="form-group required">
                <label for="invoice_date">{{ __('messages.invoice_date') }}</label>
                <!-- <input name="invoice_date" type="text" class="form-control input" id="datetime-local" data-toggle="flatpickr" data-flatpickr-default-date="{{ $invoice->invoice_date ?? now() }}" readonly="readonly" required> -->
            ...
            <div class="form-group required"> 
                ...
                <div class="input-group input-group-merge">
                    <input name="invoice_prefix" type="hidden" readonly="readonly" value="{{ $invoice->invoice_prefix }}">
                    @php
                        $date=date('dmY');
                    @endphp
                    <input name="invoice_number" type="text" readonly="readonly" maxlength="6" class="form-control form-control-prepended" value="{{  isset($invoice) ? $invoice->invoice_num : '' }}" autocomplete="off" required>
