<script>
    ...
    function initializeProductSelect2(elem) {
        elem.select2({
            ajax: { 
                url: "/public/ajax/products1/"+elem,
                type: "get",
                dataType: "json",
                delay: 250,
                data: function (params) {
             ...
             $.ajax({
                 ...
                 success:function(data) {
                   ...
                   if(data){
                     $('#driver_id').empty();
                     $('#driver_id').focus;
                     $('#driver_id').append('<option disabled selected value="">Select Driver</option>'); 
             ...
             $.ajax({
                 ...
                 success:function(data) {
                   ...
                   if(data){
                     ...
                     $('[name="product[]"]').focus;
                     $('[name="product[]"]').append('<option disabled selected value="">Select Product</option>'); 
                     $.each(data, function(key, value){
