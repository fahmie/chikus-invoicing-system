<script>
    ...
    //     var n=document.getElementById("client").value;  
    //     elem.select2({   
    //         ajax: { 
    //             url: "/ajax/products1/"+n,
    //             type: "get",
    //             dataType: "json",
    //             delay: 250,
    //             data: function (params) {
             ...
             $.ajax({
                 ...
                 success:function(data) {
                   ...
                   if(data){
                     $('#driver_id').empty();
                     $('#driver_id').focus;
                     $('#driver_id').append('<option disabled selected value="">Select Plate No.</option>'); 
                     $.each(data, function(key, value){
                     $('select[name="driver_id"]').append('<option value="'+ value.id +'">' + value.name+'</option>');
                 });
               }else{
                 $('#driver_id').empty();
               }
             ...
             $.ajax({
                 ...
                 success:function(data) {
                   ...
                   if(data){
                     ...
                     $('[name="product[]"]').focus;
                     $('[name="product[]"]').append('<option value="">Select Product</option>'); 
                     $.each(data, function(key, value){
                     $('select[name="product[]"]').append('<option value="'+ value.id +'">' + value.text+'</option>');
                    //  $('select[name="price[]"]').append('value="'+ value.price +'");
