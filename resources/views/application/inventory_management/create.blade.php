        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('Add Stock')}}</li>
                </ol>
            </nav>
            <h1 class="m-0">{{__('Add Stock')}}</h1>
        </div>
    </div>
@endsection
...
@section('content') 
   <form action="{{ route('managements.store') }}" method="POST" enctype="multipart/form-data">
        ...
        @include('application.inventory_management._form')
    </form>
@endsection
