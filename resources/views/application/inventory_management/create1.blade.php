...
@extends('layouts.app', ['page' => 'pettycash'])
        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('pettycash') }}">Petty Cash</a></li>
...
@section('content') 
    <div class="row">
    <form action="{{ route('pettycash.store_credit') }}" method="POST" enctype="multipart/form-data">
        @include('layouts._form_errors')
        @csrf
        
        @include('application.pettycash._form1')
    </form>
@endsection
...
//   var checkedValue = $('#materialUnchecked').val();
//   var x = document.getElementById('main_item');
//   if (checkedValue == "on") {
//     x.style.display = "";
//   } else {
