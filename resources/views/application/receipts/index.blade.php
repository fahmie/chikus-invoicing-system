...
@section('page_header')
    <div class="page__heading d-flex align-items-center">
        ...
        <a href="{{ route('receipts.create') }}" class="btn btn-success ml-3">
...
@section('content')
    @include('application.receipts._filters')
    ...
    <div class="card">
        <div class="card-header bg-white p-0">
            <div class="row no-gutters flex nav">
                ...
                <a href="{{ route('receipts', 'cash') }}" class="col-sm-2 border-right dashboard-area-tabs__tab card-body text-center {{ $tab == 'cash' ? 'active' : '' }}">
                    <span class="card-header__title m-0">
                        Cash
                    </span>
                </a>
        ...
        <form action="{{ route('receipts.store') }}" method="POST">
            ...
            @include('application.receipts._table')
        </form>
