    ...
    <div class="card card-form">
        <div class="row no-gutters">
            <div class="col-lg-4 card-body">
                <h6><strong class="headings-color">Credit Details</strong></h6>
                <p class="text-muted">Transaction that reduces petty cash amount at operation site</p>
            </div>
                        ...
                        <div class="form-group">
                            <div>
                              ...
                              <div class="form-check">
                                <input type="radio" class="form-check-input" id="materialChecked1" name="detail" value="CDM to HQ Account" checked>
                                <label class="form-check-label" for="materialChecked">CDM to HQ Account</label>
                              </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group mt-4">
                            <div class="form-check">
                              ...
                              <div class="form-check" id="main_item" style="display: none;">
                                <input type="text" class="form-control" name="other" value="" placeholder="Please write your expenses purpose">
                              </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group required">
                            ...
                            <input type="time" class="form-control" value="13:45:00" name="time" id="example-time-input" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group required">
                            ...
                            <input type="number" pattern="[0-9]+([\.][0-9]+)?" step="0.01" class="form-control" name="credit" value="" placeholder="" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="description">Proof of payment <span class="required" style="color:#dc3545">* </span><span style="font-size: 11px; font-style: italic; text-transform: none;">(Quotation/Receipt/Invoices Paid)</span> </label>
