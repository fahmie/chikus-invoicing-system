...
@section('page_header')
    <div class="page__heading d-flex align-items-center">
        ...
        <a href="{{ route('pettycash.create_debit') }}" class="btn btn-success ml-3">
            <i class="material-icons">add</i> 
            Debit
        </a>
        <a href="{{ route('pettycash.create_credit') }}" class="btn btn-primary ml-3">
            <i class="material-icons">add</i> 
            Credit
        </a>
    </div>
...
@section('content')
    ...
    @include('application.pettycash._filters')

    @include('application.pettycash._export')
       
        <div class="card">
                @include('application.pettycash._table')
        </div>
