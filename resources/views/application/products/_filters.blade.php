            ...
            <div class="row">
                <div class="col-sm-auto">
                    <div class="form-group">
                        ...
                        <input name="filter[name]" type="text" class="form-control" value="{{ Request::get("filter")==['name'] }}" placeholder="Search">
                    </div>
                </div>
                <div class="col-sm-auto">
                    <div class="form-group">
                        ...
                        <select id="filter[unit_id]" name="filter[unit_id]" data-toggle="select" class="form-control select2-hidden-accessible" data-select2-id="filter[unit_id]">
                            <option selected value="" disabled>{{ __('messages.select_unit') }}</option>
                ...
                <div class="col-sm-auto">
                    <div class="form-group">
                        ...
                        <input name="filter[price]" type="text" class="form-control" value="{{ Request::get("filter")==['price'] }}" placeholder="Search">
                    </div>
                </div>
            </div>
            <div class="row mb-2">
