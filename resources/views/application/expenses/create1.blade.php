        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Create Credit</li>
                </ol>
            </nav>
            <h1 class="m-0">Credit Form</h1>
        </div>
    </div>
@endsection
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-8 card-form__body card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="optradio">CDM to HQ Account
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="description">Proof of payment <span class="required" style="color:#dc3545">* </span><span style="font-size: 12px; font-style: italic; text-transform: none;">(Quotation/Receipt/Invoices Paid)</span> </label>
