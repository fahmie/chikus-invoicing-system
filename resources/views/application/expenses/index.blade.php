...
@section('page_header')
    <div class="page__heading d-flex align-items-center">
        <div class="flex">
            ...
            <h1 class="custom m-0">Petty Cash at Operation Site</h1>
        </div>
        <a href="{{ route('expenses.create') }}" class="btn btn-success ml-3">
            <i class="material-icons">add</i> 
            Debit
        </a>
        <a href="{{ route('expenses.create1') }}" class="btn btn-primary ml-3">
            <i class="material-icons">add</i> 
            Credit
        </a>
    </div>
...
@endsection
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="max-width:380px;" role="document">
            ...
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">Are you sure this item has been delivered?</h6>
                ...
                <div class="row">
                    <div class="boxes">
                        <ul style="list-style: none; padding-left:0; margin-bottom: 0;">                   
                            <li><label><strong>Plate Number:</strong> BPX991</label></li>
                            <li><span><label><strong>Supposed Tonnage:</strong> 10</label></span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="max-width:400px;" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">Any issue with quantity (tonnage) delivered?</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
                </button>
            </div>
                        ...
                        <ul style="list-style: none; padding-left:0; margin-bottom: 0;">                   
                            ...
                            <li>
                                <div class="form-group required">
                                    <label><strong>Arrival Tonnage</strong></label>
                                    <input type="text" class="form-control"  placeholder="please insert your observed tonnage (MT)">
                                </div>
                            </li>
                        </ul>
                    </div>
