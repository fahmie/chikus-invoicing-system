...
class CreateTripReportMonthlyTypeViewNew extends Migration
{
        /**
     * Run the migrations.
     *
    ...
    {
        return <<<SQL
                CREATE VIEW trip_report_monthly_type_view_new AS
    ...
    {
        return <<<SQL
            DROP VIEW IF EXISTS `trip_report_monthly_type_view_new`;
            SQL;
    }
}
