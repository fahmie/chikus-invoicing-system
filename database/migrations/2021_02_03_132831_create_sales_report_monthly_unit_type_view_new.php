...
class CreateSalesReportMonthlyUnitTypeViewNew extends Migration
{
   /**
     * Run the migrations.
     *
    ...
    {
        return <<<SQL
                CREATE VIEW sales_report_monthly_unit_type_view_new AS
                SELECT `type`,`sites_id`,YEAR(created_at) AS year,
    ...
    {
        return <<<SQL
            DROP VIEW IF EXISTS `sales_report_monthly_unit_type_view_new`;
            SQL;
    }
}
