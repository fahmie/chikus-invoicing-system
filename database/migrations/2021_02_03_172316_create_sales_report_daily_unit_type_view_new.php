...
class CreateSalesReportDailyUnitTypeViewNew extends Migration
{
        /**
     * Run the migrations.
     *
    ...
    {
        return <<<SQL
                CREATE VIEW sales_report_daily_unit_type_view_new AS
    ...
    {
        return <<<SQL
            DROP VIEW IF EXISTS `sales_report_daily_unit_type_view_new`;
            SQL;
    }
}
