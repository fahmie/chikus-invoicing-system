...
class inaccuracy_report_allprice_view extends Model
{
    protected $table = 'inaccuracy_report_allprice_view';

    protected $fillable = [
        'id', 'uid', 'type', 'client_id', 'driver_id', 'customer_id', 'company_id', 'plate_number',
        'invoice_date', 'due_date', 'invoice_number', 'do_number', 'receipt_number', 'reference_number', 
        ...
        'accurate_remark', 'sent', 'viewed', 'price', 'total_rm_inaccurate'
    ];
