...
class Invoice extends Model
{
    ...
    protected $fillable = [
        ...
        'id', 'uid', 'type', 'client_id', 'sites_id', 'driver_id', 'customer_id', 'company_id', 'transporter_id', 'location_id', 'plate_number', 'invoice_date', 'due_date', 'invoice_number', 'do_number', 'receipt_number', 'reference_number', 'status', 'paid_status', 'tax_per_item', 'discount_per_item', 'notes', 'private_notes', 'discount_type', 'discount_val', 'sub_total', 'total', 'due_amount', 'accurate', 'accurate_remark', 'accurate_amount', 'sent', 'viewed', 'created_at', 'updated_at'
    ];
     ...
     * @return string
     */
    public static function getNextInvoiceNumber($prefix,$sites_id)
    {
        // Get the last created order
        $lastOrder = Invoice::where('invoice_number', 'LIKE', $prefix . '-%')->where('sites_id', $sites_id)
                    ->orderBy('id', 'desc')
                    ->first();
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeFindBySite($query, $sites_id)
    {
    ...
    public function transporterlocation(){
    	return $this->belongsTo(TransporterLocation::class, 'location_id','id' );
    }
