...
class PDFService extends PDF_ImageAlpha
{
    ...
    function Header()
    {
        ...
        if ($this->PageNo() == 1) {
            ...
            $positionX = $this->document['w'] - $this->margins['l'] - $this->margins['r'] - max(strtoupper($this->GetStringWidth($this->l['number'])), strtoupper($this->GetStringWidth($this->l['date'])), strtoupper($this->GetStringWidth($this->l['due']))) - 45;
    ...
    private function setLanguage($language)
    {
        ...
        $l['number1'] = __('messages.plate_number');
