...
class PDFServiceDo extends PDF_ImageAlpha
{
    var $font = 'DejaVu';
        ...
        if ($this->PageNo() == 1) {
            ...
            if(!$this->hide_header) {
                ...
                if (!isset($this->productsEnded)) {
                    ...
                    $this->Cell(119, 10, strtoupper($this->l['product']), 0, 0, 'L', 1);
    ...
    function Body()
    {
        ...
        if ($this->items) {
            foreach ($this->items as $item) {
                if ($item['description']) {
                    //Precalculate height
                    $calculateHeight = new PDFServiceDo;
                ...
                $x = $this->GetX();
                $this->Cell(119, $cHeight, $item['item'], 0, 0, 'L', 1);
                if ($item['description']) {
                    $resetX = $this->GetX();
                    $resetY = $this->GetY();
