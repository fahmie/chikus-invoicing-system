...
class PDFServiceRecTrans extends PDF_ImageAlpha
{
    var $font = 'DejaVu';
    ...
    var $taxformat = '%';
    var $discountFormat = '%';
    var $margins = array('l' => 4, 't' => 20, 'r' => 4);
    ...
    function addItem($item, $sent, $price, $arrived, $totalCost, $SubDelivered,$subtotalshort, $shortagecost, $shortage, $vat = 0, $discount = 0, $total)
    {
        $p['item']             = $item;
        ...
        $p['SubDelivered'] = $SubDelivered;
        $p['shortage'] = $shortage;
        $p['shortagecost'] = $shortagecost;
        $p['subtotalshort'] = $subtotalshort;
        $p['total'] = $total;
    ...
    function addItem1($item1, $sent1, $price1, $arrived1, $totalCost1, $SubDelivered1,$subtotalshort1, $shortagecost1, $shortage1, $vat1 = 0, $discount1 = 0, $total1)
    {
        $p['item1']             = $item1;
        ...
        $p['sent1'] = $sent1;
        $p['arrived1'] = $arrived1;
        $p['totalCost1'] = $totalCost1;
        $p['SubDelivered1'] = $SubDelivered1;
        $p['shortage1'] = $shortage1;
        $p['shortagecost1'] = $shortagecost1;
        $p['subtotalshort1'] = $subtotalshort1;
        $p['total1'] = $total1;

        if ($this->discount_per_item !== false) {
            $this->firstColumnWidth = 58;
            $p['discount'] = $discount1 . " %";
            $this->discountField = true;
            $this->columns = 6;
        } else {
            $this->firstColumn = 80.4;
    ...
    function addTotalSum($name, $value, $colored = 0)
    {
        $t['name']            = $name;
        $t['value']            = $value;
        if (is_numeric($value)) {
    ...
    function Header()
    {
        ...
        if ($this->PageNo() == 1) {
            ...
            $positionX = $this->document['w'] - $this->margins['l'] - $this->margins['r'] - max(strtoupper($this->GetStringWidth($this->l['rec'])), strtoupper($this->GetStringWidth($this->l['date'])), strtoupper($this->GetStringWidth($this->l['due']))) - 58;
            ...
            if(!$this->hide_header) {
                ...
                $this->Cell($width, 6, strtoupper($this->l['to']), 0, 0, 'L', 1);
                $this->Ln(7);
            ...
            if (!isset($this->productsEnded)) {
                ...
                // $this->Cell(144.8, 10, strtoupper($this->l['product']), 0, 0, 'L', 1);
                $this->Cell(35, 4.5, " ", 0, 0, 'L', 1);

                $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                $this->Cell(18, 4.5, "(a)", 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                $this->Cell(20, 4.5, "(b)", 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                $this->Cell(22.5, 4.5, "(c)", 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                $this->Cell(22.5, 4.5, "(b) x (c) = (d)", 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                $this->Cell(22.6, 4.5, "(b) - (a) = (e)", 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                $this->Cell(18, 4.5, "(f)", 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                $this->Cell(23, 4.5, "(e) x (f) = (g)", 0, 0, 'C', 1);
                ...
                $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                $this->Cell(18, 4.5, "(d) - (g) = (h)", 0, 0, 'C', 1);
                $this->Ln();
            } else {
                $this->Ln(12);
            }
                ...
                if (!isset($this->productsEnded)) {
                    ...
                    // $this->Cell(144.8, 10, strtoupper($this->l['product']), 0, 0, 'L', 1);
                    $this->Cell(35, 4.5, strtoupper($this->l['product']), 0, 0, 'L', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(18, 4.5, "QUANTITY", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(20, 4.5, "QUANTITY", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(22.5, 4.5, "TRANSPORTER", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(22.5, 4.5, "SUBTOTAL", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(22.6, 4.5, "TOTAL", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(18, 4.5, "SHORTAGE", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(23, 4.5, "SUBTOTAL", 0, 0, 'C', 1);
                    ...
                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(18, 4.5, strtoupper($this->l['total']), 0, 0, 'C', 1);
                    $this->Ln();
                } else {
                    $this->Ln(12);
                }
                ...
                if (!isset($this->productsEnded)) {
                    ...
                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(18, 4.5, "SENT (TAN)", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(20, 4.5, "ARRIVED (TAN)", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(22.5, 4.5, "COST (RM)", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(22.5, 4.5, "ARRIVED (RM)", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(22.6, 4.5, "SHORTAGE (TAN)", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(18, 4.5, "COST (RM)", 0, 0, 'C', 1);

                    $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                    $this->Cell(23, 4.5, "SHORTAGE (RM)", 0, 0, 'C', 1);
    ...
    function Body() 
    {
        ...
        if ($this->items) {
            foreach ($this->items as $item) {
                $cHeight = $cellHeight;
                $this->SetFont($this->font, 'b', 6.8);
                $this->SetTextColor(50, 50, 50);
                $this->SetFillColor($bgcolor, $bgcolor, $bgcolor);
                $this->Cell(1, $cHeight, '', 0, 0, 'L', 1);
                $x = $this->GetX();
                $this->Cell(35, $cHeight, $item['item'], 0, 0, 'L', 1);
                $this->SetTextColor(50, 50, 50);
                $this->SetFont($this->font, '', 7);

                $this->Cell($this->columnSpacing, $cHeight, '', 0, 0, 'L', 0);
                $this->Cell(18, $cHeight, $item['sent'], 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, $cHeight, '', 0, 0, 'L', 0);
                $this->Cell(20, $cHeight, $item['arrived'], 0, 0, 'C', 1);
                
                $this->Cell($this->columnSpacing, $cHeight, '', 0, 0, 'L', 0);
                $this->Cell(22.5, $cHeight, $item['totalCost'], 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, $cHeight, '', 0, 0, 'L', 0);
                $this->Cell(22.5, $cHeight, $item['SubDelivered'], 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, $cHeight, '', 0, 0, 'L', 0);
                $this->Cell(22.6, $cHeight, $item['shortage'], 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, $cHeight, '', 0, 0, 'L', 0);
                $this->Cell(18, $cHeight, $item['shortagecost'], 0, 0, 'C', 1);

                $this->Cell($this->columnSpacing, $cHeight, '', 0, 0, 'L', 0);
                $this->Cell(23, $cHeight, $item['subtotalshort'], 0, 0, 'C', 1);
                ...
                $this->Cell($this->columnSpacing, $cHeight, '', 0, 0, 'L', 0);
                $this->SetFillColor($bgcolor, $bgcolor, $bgcolor);
                $this->Cell(18, $cHeight, $item['total'], 0, 0, 'C', 1);
                $this->Ln();
        ...
        if ($this->items1) {
            foreach ($this->items1 as $item1) {
                ...
                $x = $this->GetX();
                $this->Cell(35, $cHeight, $item1['item1'], 'T,B', 0, 'L', 1);
                $this->SetTextColor(50, 50, 50);
                $this->SetFont($this->font, 'b', 7);

                $this->Cell($this->columnSpacing, $cHeight, '', 'T,B', 0, 'L', 0);
                $this->Cell(18, $cHeight, $item1['sent1'], 'T,B', 0, 'C', 1);

                $this->Cell($this->columnSpacing, $cHeight, '', 'T,B', 0, 'L', 0);
                $this->Cell(20, $cHeight, $item1['arrived1'], 'T,B', 0, 'C', 1);
                
                $this->Cell($this->columnSpacing, $cHeight, '', 'T,B', 0, 'L', 0);
                $this->Cell(22.5, $cHeight, $item1['totalCost1'], 'T,B', 0, 'C', 1);

                $this->Cell($this->columnSpacing, $cHeight, '', 'T,B', 0, 'L', 0);
                $this->Cell(22.5, $cHeight, $item1['SubDelivered1'], 'T,B', 0, 'C', 1);

                $this->Cell($this->columnSpacing, $cHeight, '', 'T,B', 0, 'L', 0);
                $this->Cell(22.6, $cHeight, $item1['shortage1'], 'T,B', 0, 'C', 1);

                $this->Cell($this->columnSpacing, $cHeight, '', 'T,B', 0, 'L', 0);
                $this->Cell(18, $cHeight, $item1['shortagecost1'], 'T,B', 0, 'C', 1);

                $this->Cell($this->columnSpacing, $cHeight, '', 'T,B', 0, 'L', 0);
                $this->Cell(23, $cHeight, $item1['subtotalshort1'], 'T,B', 0, 'C', 1);
                ...
                $this->SetFillColor($bgcolor, $bgcolor, $bgcolor);
                // $this->SetFillColor(193, 193, 193);
                $this->Cell(18, $cHeight, $item1['total1'], 'T,B', 0, 'C', 1);
                $this->Ln();
                $this->Ln(($this->columnSpacing));
            }
        }
        ...
        if ($this->totals) {
            foreach ($this->totals as $total) {
                ...
                for ($i = 0; $i < $this->columns - 3; $i++) {
                    $this->Cell(24.3, $cellHeight, '', 0, 0, 'L', 0);
                ...
                $this->Cell(41 - 1, $cellHeight, $total['name'], 0, 0, 'L', 1);
                $this->Cell($this->columnSpacing, $cellHeight, '', 0, 0, 'L', 0);
                $this->SetFont($this->font, 'b', 8);
                $this->SetFillColor($bgcolor, $bgcolor, $bgcolor);
                if ($total['colored']) {
                ...
                $this->Cell(41.2, $cellHeight, $total['value'], 0, 0, 'C', 1);
                $this->Ln();
                $this->Ln($this->columnSpacing);
            }
        }
        ...
        if ($this->totalsbal) {
            foreach ($this->totalsbal as $totalbal) {
                ...
                $this->SetFont($this->font, 'b', 8);
                $this->Cell(1, $cellHeight, '', 0, 0, 'L', 1);
                $this->Cell(41 - 1, $cellHeight, $totalbal['name'], 0, 0, 'L', 1);
                $this->Cell($this->columnSpacing, $cellHeight, '', 0, 0, 'L', 0);
                $this->SetFont($this->font, 'b', 8);
                $this->SetFillColor($this->color[0], $this->color[1], $this->color[2]);
                    // $this->SetFillColor($bgcolor, $bgcolor, $bgcolor);
                ...
                $this->Cell(41.2, $cellHeight, $totalbal['value'], 0, 0, 'C', 1);
                $this->Ln();
                $this->Ln($this->columnSpacing);
            }
        }
    ...
    private function setLanguage($language)
    {
        ...
        $l['arrived'] = __('T.Arrived');
        $l['sent'] = __('T.Sent');
        $l['product'] = 'Invoice Number';
        $l['discount'] = __('messages.discount');
        $l['vat'] = __('messages.tax');
        $l['totalCost'] = __('Trans.Cost');
        $l['total'] = __('Total');
        $l['SubDelivered'] = __('SubT.Arrived');
        $l['shortage'] = __('T.short.');
        $l['shortagecost'] = __('Short.Cost');
        $l['subtotalshort'] = __('SubT. Short.');
