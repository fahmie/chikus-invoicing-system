...
if (! function_exists('get_sites_select2_array')) {
    /**
     * get_sites_select2_array
     *
     * @return collect
     */
    function get_sites_select2_array($company_id)
    {
        return Site::getSelect2Array($company_id);
    }
}

if (! function_exists('get_supplier_select2_array')) {
    /**
     * get_supplier_select2_array
     *
     * @return collect
     */
    function get_supplier_select2_array($sites_id)
    {
        return Supplier::getSelect2Array($sites_id);
    }
}

if (! function_exists('get_product_select2_array')) {
    /**
     * get_product_select2_array
     *
     * @return collect
     */
    function get_product_select2_array($sites_id)
    {
        return ProductInventory::getSelect2Array($sites_id);
    }
}
