<form action="" method="GET">
    <div class="card card-form d-flex flex-column flex-sm-row">
        <div class="card-form__body card-body-form-group flex">
            <div class="row">
                <div class="col-sm-auto">
                    <div class="form-group">
                        <label for="filter[estimate_number]"><?php echo e(__('messages.estimate_number')); ?></label>
                        <input name="filter[estimate_number]" type="text" class="form-control" value="<?php echo e(Request::get("filter")==['estimate_number']); ?>" placeholder="<?php echo e(__('messages.search')); ?>">
                    </div>
                </div>
                <div class="col-sm-auto">
                    <div class="form-group">
            ...
            <div class="row mb-2">
                <div class="col-12">
                    <a href="<?php echo e(route('estimates')); ?>"><?php echo e(__('messages.clear_filters')); ?></a>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\chikus\resources\views/application/estimates/_filters.blade.php ENDPATH**/ ?>